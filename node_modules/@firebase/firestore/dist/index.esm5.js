...
import { FirebaseError as f, getUA as d, isSafari as p, getModularInstance as v, createMockUserToken as y, deepEqual as m, getDefaultEmulatorHost as g, isIndexedDBAvailable as w } from "@firebase/util";
...
function xc(t, e) {
    var n = "object" == typeof t ? t : s(), r = "string" == typeof t ? t : e || "(default)", i = _getProvider(n, "firestore").getImmediate({
        identifier: r
    });
    if (!i._initialized) {
        var o = g("firestore");
        if (o) {
            var u = o.split(":"), a = u[0], c = u[1];
            Qa(i, a, parseInt(c, 10));
        }
    }
    return i;
}
