...
import { FirebaseError as h, getModularInstance as p, getDefaultEmulatorHost as d, createMockUserToken as y, deepEqual as m } from "@firebase/util";
 ...
 * limitations under the License.
 */
var g = "9.11.0", w = new l("@firebase/firestore");
...
function ln(t, e) {
    var n = "object" == typeof t ? t : u(), r = "string" == typeof t ? t : e || "(default)", i = _getProvider(n, "firestore/lite").getImmediate({
        identifier: r
    });
    if (!i._initialized) {
        var o = d("firestore");
        if (o) {
            var a = o.split(":"), s = a[0], c = a[1];
            fn(i, s, parseInt(c, 10));
        }
    }
    return i;
}
...
a("firestore-lite", "3.6.0", ""), a("firestore-lite", "3.6.0", "esm5");
